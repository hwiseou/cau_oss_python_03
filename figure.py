...
line class를 이용하여 선의 길이를  설정/참조를 수행하며 area_square, area_circle, area_regualer_triangle 함수로
...
class line:
    ...
    클래스에 대한 설명은 CLASS의 선언 바로 아래에 위치합니다.
     ...
     변슈로는 외부애서 접근 불가능한 __length가 있으며, 해당 변수를 수정 및 접근하기 위해
     set_length와, egt_length 메소드를 제공합니다
    """
    __length = 0
